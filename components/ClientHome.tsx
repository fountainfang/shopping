...
export default function ClientHome({ session, dynamicGroups }: DirectoryProps) {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#0f172a] text-white font-sans selection:bg-teal-500 selection:text-white">
            ...
            <main className="relative z-10 container mx-auto px-4 md:px-8 py-12 flex-grow space-y-16">
